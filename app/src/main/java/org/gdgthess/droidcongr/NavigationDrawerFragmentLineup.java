 ...
 */
public class NavigationDrawerFragmentLineup extends Fragment {
    ...
    public NavigationDrawerFragmentLineup() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.activity_lineup_navigation_drawer_fragment, container, false);
