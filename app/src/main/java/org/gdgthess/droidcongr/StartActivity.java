...
public class StartActivity extends FragmentActivity implements ConnectionCallbacks, OnConnectionFailedListener, View.OnClickListener {
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        try {
            ...
            String personPhotoUrl = Plus.PeopleApi.getCurrentPerson(mGoogleApiClient).getImage().getUrl();
            personPhotoUrl = personPhotoUrl.substring(0, personPhotoUrl.length() - 2) + 200;

            editor.putString("usermail",Plus.AccountApi.getAccountName(mGoogleApiClient));
            editor.putString("username",Plus.PeopleApi.getCurrentPerson(mGoogleApiClient).getDisplayName());
            editor.putString("userprofpic",personPhotoUrl);
            editor.putString("usercovrpic",Plus.PeopleApi.getCurrentPerson(mGoogleApiClient).getCover().getCoverPhoto().getUrl());
            editor.apply();
            ...
            Log.i("EXCEPTION ERROR MESSAGE",exceptionString);
